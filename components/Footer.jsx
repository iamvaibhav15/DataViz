      ...
      <footer className="bg-gray-900 text-gray-300 py-12 mt-16">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h4 className="text-white text-lg font-semibold mb-4">Vizulytics</h4>
              <p className="mb-4">Transforming data into actionable insights with cutting-edge analytics solutions.</p>
            ...
            <div>
              ...
              <ul>
                ...
                <li className="mb-2"><a href="#" className="hover:text-white">Use Cases</a></li>
                <li className="mb-2"><a href="#" className="hover:text-white">Integration</a></li>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p>© 2025 Vizulytics. All rights reserved.</p>
            <div className="mt-4 md:mt-0">
              <a href="#" className="text-sm mr-4 hover:text-white">Privacy Policy</a>
              <a href="#" className="text-sm mr-4 hover:text-white">Terms of Service</a>
