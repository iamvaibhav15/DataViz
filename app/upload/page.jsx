...
export default function FileUploader() {
  ...
  return (
    <div className="max-w-xl mx-auto p-8 bg-gray-900 rounded-xl shadow-xl space-y-6" onKeyDown={handleKeyPress} tabIndex={0}>
      <div className="flex items-center justify-center mb-6">
        <svg className="w-8 h-8 mr-3 text-purple-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M20 13V6C20 4.89543 19.1046 4 18 4H6C4.89543 4 4 4.89543 4 6V18C4 19.1046 4.89543 20 6 20H13" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M18 21V15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <>
            ...
            <div className="mt-4 flex items-center justify-center">
              <div className="bg-gray-800 py-1 px-3 rounded-md flex items-center space-x-1">
                <span className="text-xs text-gray-400">Supported format:</span>
                <span className="text-xs font-medium text-purple-400">.CSV</span>
              </div>
            </div>
          </>
        )}
      ...
      <div className="space-y-3">
        ...
        <div className="text-center">
          <span className="text-sm text-gray-500">Need help with your data? <a href="#" className="text-purple-400 hover:text-purple-300">View guide</a></span>
        </div>
      </div>
    </div>
  );
