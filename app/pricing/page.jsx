...
export default function Pricing() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "All paid plans come with a 14-day free trial. No credit card required to start. You can explore all features and decide which plan works best for your needs."
    },
    {
    ...
    },
    {
      ...
      answer: "Your data security is our priority. We use enterprise-grade encryption, regular security audits, and comply with industry standards to ensure your data remains protected."
    }
  ];
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-gray-100">
      ...
      <style jsx>{`
        ...
        .animated-gradient {
          background: linear-gradient(90deg, #a78bfa, #ec4899, #8b5cf6, #d946ef, #a78bfa);
      ...
      <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-400">
        Unlock the full potential of your data with our flexible pricing options
      </p>
    </div>
        ...
        <div className="mt-12 flex justify-center">
          <div className="bg-gray-800 p-1 rounded-lg inline-flex">
            ...
            >
              Annual <span className="text-xs text-purple-400 font-normal">Save 20%</span>
            </button>
          </div>
        </div>
        ...
        <div className="mt-16 grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800 rounded-2xl shadow-xl overflow-hidden hover:translate-y-[-4px] transition-transform duration-300">
            <div className="p-8">
              ...
              <p className="mt-4 text-gray-400">Perfect for individuals just getting started with data visualization</p>
              <div className="mt-6">
              ...
              <ul className="mt-8 space-y-4">
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-purple-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="bg-gray-800 rounded-2xl shadow-xl overflow-hidden transform lg:scale-105 hover:translate-y-[-4px] transition-transform duration-300 border border-purple-500 relative">
            ...
            <div className="p-8">
              ...
              <p className="mt-4 text-gray-400">Ideal for professionals and growing teams</p>
              <div className="mt-6">
                ...
                <p className="text-gray-400 mt-1">
                  {billingCycle === 'annual' && 'Billed annually ($95.88/year)'}
          ...
          <div className="bg-gray-800 rounded-2xl shadow-xl overflow-hidden hover:translate-y-[-4px] transition-transform duration-300">
            <div className="p-8">
              ...
              <p className="mt-4 text-gray-400">Custom solutions for organizations with advanced needs</p>
              <div className="mt-6">
                <p className="text-5xl font-extrabold text-white">Custom</p>
                <p className="text-gray-400 mt-1">Tailored to your requirements</p>
              </div>
        ...
        <div className="mt-20 bg-gray-800 rounded-xl overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-700">
              <thead>
                <tr>
                  <th className="py-6 px-8 text-left text-sm font-medium text-gray-300 uppercase tracking-wider">Feature</th>
                  <th className="py-6 px-8 text-center text-sm font-medium text-gray-300 uppercase tracking-wider">Basic</th>
                  <th className="py-6 px-8 text-center text-sm font-medium text-purple-400 uppercase tracking-wider">Pro</th>
                  <th className="py-6 px-8 text-center text-sm font-medium text-gray-300 uppercase tracking-wider">Enterprise</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-700">
                <tr>
                  <td className="py-4 px-8 text-sm font-medium">Visualizations</td>
                  <td className="py-4 px-8 text-center">Up to 5</td>
                  <td className="py-4 px-8 text-center">Unlimited</td>
                  <td className="py-4 px-8 text-center">Unlimited</td>
                </tr>
                <tr>
                  <td className="py-4 px-8 text-sm font-medium">Chart Types</td>
                ...
                <tr>
                  <td className="py-4 px-8 text-sm font-medium">Data Sources</td>
                  <td className="py-4 px-8 text-center">CSV only</td>
                  <td className="py-4 px-8 text-center">Multiple types</td>
                  <td className="py-4 px-8 text-center">All + Custom</td>
                </tr>
                <tr>
                  <td className="py-4 px-8 text-sm font-medium">Data Storage</td>
                  <td className="py-4 px-8 text-center">1GB</td>
                  <td className="py-4 px-8 text-center">10GB</td>
                  <td className="py-4 px-8 text-center">Unlimited</td>
                </tr>
                <tr>
                  <td className="py-4 px-8 text-sm font-medium">Dashboard Sharing</td>
                  <td className="py-4 px-8 text-center">
                    <svg className="h-5 w-5 text-gray-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                  </td>
                  <td className="py-4 px-8 text-center">
                    <svg className="h-5 w-5 text-purple-400 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tr>
                  <td className="py-4 px-8 text-sm font-medium">Automated Reports</td>
                  <td className="py-4 px-8 text-center">
                    <svg className="h-5 w-5 text-gray-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                ...
                <tr>
                  <td className="py-4 px-8 text-sm font-medium">API Access</td>
                  <td className="py-4 px-8 text-center">
                    <svg className="h-5 w-5 text-gray-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                    </svg>
            ...
            <div className="px-8 py-12 md:px-12 lg:flex lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-lg text-lg text-purple-200">
                  Get started with a 14-day free trial of any paid plan. No credit card required.
                </p>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-300">
                "DataViz transformed how we analyze our campaign performance. The visualizations are stunning and insights are now accessible to everyone on the team."
              </p>
            </div>
            <div className="bg-gray-800 rounded-xl p-6 shadow-md">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-300">
                "The Enterprise plan was exactly what we needed. The custom integrations allow us to bring all our data sources together for comprehensive analytics."
              </p>
            </div>
            <div className="bg-gray-800 rounded-xl p-6 shadow-md">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-300">
                "We started with the Pro plan and were impressed with the flexibility. The automated reporting feature alone has saved us countless hours."
              </p>
            </div>
          </div>
        </div>
